...
public interface ILogChoosing
{
    IEnumerable<string> ChooseWay();
}
public class OneWay: ILogChoosing
{
    IEnumerable<string> ILogChoosing.ChooseWay()
    {
        return null;
    }
}
public class SecondWay : ILogChoosing
{
    IEnumerable<string> ILogChoosing.ChooseWay()
    {
        return null;
...
class Log
{
    public void ChooseWay(ILogChoosing log)
    {
        //
    }
}
